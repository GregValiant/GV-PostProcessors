...
class PauseAtHeight(Script):
    ...
    def getSettingDataString(self) -> str:
        return """{
            ...
            "settings":
            {
                ...
                "one_at_a_time_renum":
                {
                    "label": "Enable 'One-at-a-Time' mode pauses (all models)",
                ...
                "unload_reload_speed":
                {
                    ...
                    "value": 50,
                    "default_value": 50,
                    "enabled": "enable_pause_at_height and pause_method not in ['griffin', 'repetier'] and reason_for_pause == 'reason_filament' and pause_at == 'layer_no'"
                },
                "reload_amount":
                {
                    "label": "     Reload Amount",
    ...
    def execute(self, data):
        ...
        if not self.getSettingValueByKey("enable_pause_at_height"):
            data[0] += ";    [Pause At Height] Not enabled\n"
            Logger.log("i", "[Pause At Height] Not enabled")
            return data
    ...
    def _pause_layer_from_height(self, data: str) -> str:
        ...
        for p_hgt in pause_height_list:
            ...
            try:
                ...
                Logger.log("w", "PauseAtHeight error - An entered 'Height' could not be converted to a number.")
