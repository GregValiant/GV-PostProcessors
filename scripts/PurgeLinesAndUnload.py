...
class PurgeLinesAndUnload(Script):
    ...
    'Move to Prime Tower' is not a setting and only requires that the script is in the active post-processor list.
    """
    ...
    def _get_build_plate_extents(self):
        ...
        If there are "extruder offsets" they are used to adjust the 'machine_right' and 'machine_back' independent of any disallowed areas.
        """
