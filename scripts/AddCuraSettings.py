...
class AddCuraSettings(Script):
    ...
    def execute(self, data): # Application.getInstance().getPrintInformation().
        ...
        if bool(self.getSettingValueByKey("machine_set")) or all_or_some == "all_settings":
            setting_data += ";\n;  [Machine]\n"
            if complete_set: setting_data += ";Wait for bed heatup: " + str(mycura.getProperty("material_bed_temp_wait", "value")) + "\n"
            if complete_set: setting_data += ";Wait for Nozzle Heatup: " + str(mycura.getProperty("material_print_temp_wait", "value")) + "\n"
            if complete_set: setting_data += ";Add Print Temp Before StartUp: " + str(mycura.getProperty("material_print_temp_prepend", "value")) + "\n"
            if complete_set: setting_data += ";Add Bed Temp Before StartUp: " + str(mycura.getProperty("material_bed_temp_prepend", "value")) + "\n"
            ...
            if complete_set: setting_data += ";Machine Center is Zero: " + str(mycura.getProperty("machine_center_is_zero", "value")) + "\n"
            if complete_set: setting_data += ";Machine Extruder Count: " + str(mycura.getProperty("machine_extruder_count", "value")) + "\n"
            ...
            if complete_set: setting_data += ";Enable Nozzle Temperature Control: " + str(mycura.getProperty("machine_nozzle_temp_enabled", "value")) + "\n"
            if complete_set: setting_data += ";Heat Up Speed: " + str(mycura.getProperty("machine_nozzle_heat_up_speed", "value")) + "°/sec\n"
            if complete_set: setting_data += ";Cool Down Speed: " + str(mycura.getProperty("machine_nozzle_cool_down_speed", "value")) + "°/sec\n"
            if complete_set: setting_data += ";Minimal Time Standby Temperature: " + str(mycura.getProperty("machine_min_cool_heat_time_window", "value")) + " sec\n"
            if complete_set: setting_data += ";G-code Flavor: " + str(mycura.getProperty("machine_gcode_flavor", "value")) + "\n"
            if complete_set: setting_data += ";Firmware Retraction: " + str(mycura.getProperty("machine_firmware_retract", "value")) + "\n"
            if machine_extruder_count > 1:
                ...
                setting_data += "; Shared Nozzle Initial Retraction: " + str(mycura.getProperty("machine_extruders_shared_nozzle_initial_retraction", "value")) + " mm\n"
            if complete_set:
            ...
            if complete_set: setting_data += ";Gantry Height: " + str(mycura.getProperty("gantry_height", "value")) + " mm\n"
            if complete_set: setting_data += ";Nozzle Identifier: " + str(mycura.getProperty("machine_nozzle_id", "value")) + "\n"
            ...
            if complete_set:
                setting_data += ";Use Extruder Offsets in Gcode: " + str(mycura.getProperty("machine_use_extruder_offset_to_offset_coords", "value")) + "\n"
                setting_data += ";Z Position for Extruder Prime: " + str(mycura.getProperty("extruder_prime_pos_z", "value")) + "\n"
        ...
        if bool(self.getSettingValueByKey("quality_set")) or all_or_some == "all_settings":
            ...
            setting_data += ";Initial Layer Line Width: " + str(mycura.getProperty("initial_layer_line_width_factor", "value")) + " %\n"
        ...
        if bool(self.getSettingValueByKey("wall_set")) or all_or_some == "all_settings":
            ...
            if complete_set: setting_data += ";Wall Transition Length: " + str(mycura.getProperty("wall_transition_length", "value")) + " mm\n"
            setting_data += ";Outer-Wall Wipe Dist: " + str(extruder[wall_0_extruder_nr].getProperty("wall_0_wipe_dist", "value")) + " mm\n"
            if complete_set: setting_data += ";Wall Distribution Count: " + str(mycura.getProperty("wall_distribution_count", "value")) + "\n"
            if complete_set: setting_data += ";Wall Transitioning Threshold Angle: " + str(mycura.getProperty("wall_transition_angle", "value")) + "°\n"
            if complete_set: setting_data += ";Wall Transitioning Filter Distance: " + str(mycura.getProperty("wall_transition_filter_distance", "value")) + " mm\n"
            if complete_set: setting_data += ";Wall Transitioning Filter Margin: " + str(mycura.getProperty("wall_transition_filter_deviation", "value")) + " mm\n"
            setting_data += ";Outer-Wall Inset: " + str(extruder[wall_0_extruder_nr].getProperty("wall_0_inset", "value")) + " mm\n"
            setting_data += ";Optimize Wall Printing Order: " + str(mycura.getProperty("optimize_wall_printing_order", "value")) + "\n"
            ...
            if complete_set: setting_data += ";Minimum Even Wall Line Width: " + str(mycura.getProperty("min_even_wall_line_width", "value")) + " mm\n"
            if complete_set: setting_data += ";Minimum Odd Wall Line Width: " + str(mycura.getProperty("min_odd_wall_line_width", "value")) + " mm\n"            
        ...
        if bool(self.getSettingValueByKey("topbot_set")) or all_or_some == "all_settings":
            ...
            if complete_set: setting_data += ";Small Top/Bottom Width: " + str(mycura.getProperty("small_skin_width", "value")) + "\n"
            if complete_set: setting_data += ";Small Top/Bottom On Surface: " + str(mycura.getProperty("small_skin_on_surface", "value")) + "\n"
            ...
            if complete_set: setting_data += ";Skin Expand Distance: " + str(extruder[top_bottom_extruder_nr].getProperty("expand_skins_expand_distance", "value")) + " mm\n"
            setting_data += ";Top Skin Expand Distance: " + str(extruder[top_bottom_extruder_nr].getProperty("top_skin_expand_distance", "value")) + " mm\n"
            setting_data += ";Bottom Skin Expand Distance: " + str(extruder[top_bottom_extruder_nr].getProperty("bottom_skin_expand_distance", "value")) + " mm\n"
        ...
        if bool(self.getSettingValueByKey("material_set")) or all_or_some == "all_settings":
            setting_data += ";\n;  [Material]\n"
            if complete_set: setting_data += ";Heated Build Volume: " + str(mycura.getProperty("machine_heated_build_volume", "value")) + "\n"
            if complete_set and bool(mycura.getProperty("machine_heated_build_volume", "value")):
                setting_data += ";Build Volume Temp: " + str(mycura.getProperty("build_volume_temperature", "value")) + "°\n"
            if complete_set: setting_data += ";Extrusion Cool Down Speed Modifier: " + str(mycura.getProperty("material_extrusion_cool_down_speed", "value")) + " mm/sec\n"
        ...
        if bool(self.getSettingValueByKey("speed_set")) or all_or_some == "all_settings":
            ...
            for num in range(0,machine_extruder_count):
                ...
                if complete_set: setting_data += ";  Acceleration Prime Tower: " + str(mycura.getProperty("acceleration_prime_tower", "value")) + " mm/sec²\n"
            ...
            try: #  For compatibility with 4.x
                ...
                pass
            if bool(mycura.getProperty("prime_tower_enable", "value")) and machine_extruder_count > 1:
                if complete_set: setting_data += ";Speed Prime Tower: " + str(mycura.getProperty("speed_prime_tower", "value")) + " mm/sec\n"
        ...
        if bool(self.getSettingValueByKey("support_set")) or all_or_some == "all_settings":
            ...
            if bool(mycura.getProperty("support_enable", "value")):
                ...
                if complete_set and str(extruder[support_extruder_nr].getProperty("support_structure", "value")) == "tree":
                    ...
                    setting_data += ";Limit Branch Reach: " + str(mycura.getProperty("support_tree_limit_branch_reach", "value")) + " mm\n"
                    setting_data += ";Optimal Branch Range: " + str(mycura.getProperty("support_tree_branch_reach_limit", "value")) + " mm\n"
                    setting_data += ";Rest Preference: " + str(mycura.getProperty("support_tree_rest_preference", "value")) + " mm\n"
                ...
                setting_data += ";Fan Speed Override: " + str(mycura.getProperty("support_fan_enable", "value")) + "\n"
                setting_data += ";Supported Skin Fan Speed: " + str(mycura.getProperty("support_supported_skin_fan_speed", "value")) + "°\n"
                setting_data += ";Support Use Towers: " + str(mycura.getProperty("support_use_towers", "value")) + "\n"
                if complete_set: setting_data += ";Support Tower Diameter: " + str(mycura.getProperty("support_tower_diameter", "value")) + " mm\n"
                ...
                if complete_set: setting_data += ";Dropdown Support Mesh: " + str(mycura.getProperty("support_mesh_drop_down", "value")) + "\n"
                if complete_set: setting_data += ";Scene Has Support Meshes: " + str(mycura.getProperty("support_meshes_present", "value")) + "\n"
        ...
        if bool(self.getSettingValueByKey("adhesion_set")) or all_or_some == "all_settings":
            ...
            if str(mycura.getProperty("adhesion_type", "value")) != "none":
                ...
                if str(mycura.getProperty("adhesion_type", "value")) == "skirt":
                    ...
                    if complete_set: setting_data += ";Raft Remove Inside Corners: " + str(mycura.getProperty("raft_remove_inside_corners", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";Raft Remove Base Inside Corners: " + str(mycura.getProperty("raft_base_remove_inside_corners", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";Raft Remove Middle Inside Corners: " + str(mycura.getProperty("raft_interface_remove_inside_corners", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";Raft Remove Top Inside Corners: " + str(mycura.getProperty("raft_surface_remove_inside_corners", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";Raft Smoothing: " + str(mycura.getProperty("raft_smoothing", "value")) + " mm\n"
                    if complete_set: setting_data += ";Raft Base Smoothing: " + str(mycura.getProperty("raft_base_smoothing", "value")) + " mm\n"
                    if complete_set: setting_data += ";Raft Middle Smoothing: " + str(mycura.getProperty("raft_interface_smoothing", "value")) + " mm\n"
                    if complete_set: setting_data += ";Raft Top Smoothing: " + str(mycura.getProperty("raft_surface_smoothing", "value")) + " mm\n"
                    ...
                    if complete_set: setting_data += ";Raft Wall Count: " + str(mycura.getProperty("raft_wall_count", "value")) + "\n"
                    if complete_set: setting_data += ";Raft Base Wall Count: " + str(mycura.getProperty("raft_base_wall_count", "value")) + "\n"
                    if complete_set: setting_data += ";Raft Interface Wall Count: " + str(mycura.getProperty("raft_interface_wall_count", "value")) + "\n"
                    if complete_set: setting_data += ";Raft Top Wall Count: " + str(mycura.getProperty("raft_surface_wall_count", "value")) + "\n"
                    ...
                    if complete_set: setting_data += ";Raft Flow: " + str(mycura.getProperty("raft_flow", "value")) + "%\n"
        ...
        if (bool(self.getSettingValueByKey("dualext_set")) or all_or_some == "all_settings") and machine_extruder_count > 1:
            ...
            if bool(mycura.getProperty("prime_tower_enable", "value")):
                setting_data += ";  Prime Tower Type: " + str(mycura.getProperty("prime_tower_mode", "value")) + "\n"
                ...
                for num in range(0, machine_extruder_count):
                    ...
                    if complete_set: setting_data += ";  Prime Tower Max Bridging Distance: " + str(mycura.getProperty("prime_tower_max_bridging_distance", "value")) + " mm\n"
                    if complete_set: setting_data += ";  Prime Tower Min Shell Thickness: " + str(mycura.getProperty("prime_tower_min_shell_thickness", "value")) + " mm\n"
                ...
                if complete_set: setting_data += ";  Prime Tower Wipe Enabled: " + str(mycura.getProperty("prime_tower_wipe_enabled", "value")) + "\n"
                setting_data += ";  Prime Tower Brim: " + str(mycura.getProperty("prime_tower_brim_enable", "value")) + "\n"
                setting_data += ";  Prime Tower Base Size: " + str(mycura.getProperty("prime_tower_base_size", "value")) + " mm\n"
                if complete_set: setting_data += ";  Prime Tower Base Height: " + str(mycura.getProperty("prime_tower_base_height", "value")) + " mm\n"
                ...
                if complete_set: setting_data += ";  Prime Tower Raft Line Spacing: " + str(mycura.getProperty("prime_tower_raft_base_line_spacing", "value")) + " mm\n"
            ...
            if bool(mycura.getProperty("ooze_shield_enabled", "value")):
                if complete_set: setting_data += ";  Ooze Shield Angle: " + str(mycura.getProperty("ooze_shield_angle", "value")) + "°\n"
                if complete_set: setting_data += ";  Ooze Shield Distance: " + str(mycura.getProperty("ooze_shield_dist", "value")) + " mm\n"
        ...
        if bool(self.getSettingValueByKey("meshfix_set")) or all_or_some == "all_settings":
            ...
            if complete_set: setting_data += ";Extensive Stitching: " + str(mycura.getProperty("meshfix_extensive_stitching", "value")) + "\n"
            if complete_set: setting_data += ";Keep Disconnected Faces: " + str(mycura.getProperty("meshfix_keep_open_polygons", "value")) + "\n"
            if complete_set: setting_data += ";Merged Mesh Overlap: " + str(mycura.getProperty("multiple_mesh_overlap", "value")) + " mm\n"
            if complete_set: setting_data += ";Remove Mesh Intersection: " + str(mycura.getProperty("carve_multiple_volumes", "value")) + "\n"
            if complete_set: setting_data += ";Alternate Mesh Removal: " + str(mycura.getProperty("alternate_carve_order", "value")) + "\n"
            setting_data += ";Remove Empty First Layers: " + str(mycura.getProperty("remove_empty_first_layers", "value")) + "\n"
            if complete_set: setting_data += ";Maximum Resolution: " + str(mycura.getProperty("meshfix_maximum_resolution", "value")) + " mm\n"
            if complete_set: setting_data += ";Maximum Travel Resolution: " + str(mycura.getProperty("meshfix_maximum_travel_resolution", "value")) + " mm\n"
            if complete_set: setting_data += ";Maximum Deviation: " + str(mycura.getProperty("meshfix_maximum_deviation", "value")) + " mm\n"
            if complete_set: setting_data += ";Maximum Extrusion Area Deviation: " + str(mycura.getProperty("meshfix_maximum_extrusion_area_deviation", "value")) + " µm²\n"
            setting_data += ";Fluid Motion Enable: " + str(mycura.getProperty("meshfix_fluid_motion_enabled", "value")) + "\n"
            if complete_set: setting_data += ";Fluid Motion Shift Distance: " + str(mycura.getProperty("meshfix_fluid_motion_shift_distance", "value")) + " mm\n"
            if complete_set: setting_data += ";Fluid Motion Small Distance: " + str(mycura.getProperty("meshfix_fluid_motion_small_distance", "value")) + " mm\n"
            if complete_set: setting_data += ";Fluid Motion Angle: " + str(mycura.getProperty("meshfix_fluid_motion_angle", "value")) + "°\n"
        ...
        if bool(self.getSettingValueByKey("experimental_set")) or all_or_some == "all_settings":
            setting_data += ";\n;  [Experimental]\n"
            setting_data += ";Slicing Tolerance: " + str(mycura.getProperty("slicing_tolerance", "value")) + "\n"
            setting_data += ";Infill Travel Optimization: " + str(mycura.getProperty("infill_enable_travel_optimization", "value")) + "\n" 
            ...
            if complete_set: setting_data += ";Minimum Polygon Circumference: " + str(mycura.getProperty("minimum_polygon_circumference", "value")) + "\n"
            setting_data += ";Generate Interlocking Structure: " + str(mycura.getProperty("interlocking_enable", "value")) + "\n"
            ...
            if bool(mycura.getProperty("draft_shield_enabled", "value")) and complete_set:
                setting_data += ";  Draft Shield Distance: " + str(mycura.getProperty("draft_shield_dist", "value")) + " mm\n"
                setting_data += ";  Draft Shield Limitation: " + str(mycura.getProperty("draft_shield_height_limitation", "value")) + " mm\n"
            ...
            if bool(mycura.getProperty("conical_overhang_enabled", "value")) and complete_set:
                setting_data += ";  Maximum Model Angle: " + str(mycura.getProperty("conical_overhang_angle", "value")) + " mm\n"
                setting_data += ";  Maximum Overhang Hole Area: " + str(mycura.getProperty("conical_overhang_hole_size", "value")) + " mm\n"
            setting_data += ";Coasting Enable: " + str(mycura.getProperty("coasting_enable", "value")) + "\n"
            if bool(mycura.getProperty("coasting_enable", "value")):
                if machine_extruder_count > 1 and complete_set:
                    for num in range(0, machine_extruder_count):
                        setting_data += ";Extruder " + str(num + 1) + " (T" + str(num) + "):\n"
            ...
            if bool(mycura.getProperty("support_conical_enabled", "value")) and complete_set:
                if machine_extruder_count > 1:
                    for num in range(0, machine_extruder_count):
                        setting_data += ";Extruder " + str(num + 1) + " (T" + str(num) + "):\n"
            ...
            if bool(mycura.getProperty("support_conical_enabled", "value")):
            ...
            if complete_set: setting_data += ";Overhanging Wall Angle: " + str(mycura.getProperty("wall_overhang_angle", "value")) + "°\n"
            if complete_set: setting_data += ";Overhanging Seam Angle: " + str(mycura.getProperty("seam_overhang_angle", "value")) + "°\n"
            if complete_set: setting_data += ";Overhanging Wall Speed: " + str(mycura.getProperty("wall_overhang_speed_factor", "value")) + " %\n" 
            ...
            if bool(mycura.getProperty("bridge_settings_enabled", "value")):
                if complete_set: setting_data += ";  Bridge Wall Min Length: " + str(mycura.getProperty("bridge_wall_min_length", "value")) + "\n"
                if complete_set: setting_data += ";  Bridge Skin Supt Threshold: " + str(mycura.getProperty("bridge_skin_support_threshold", "value")) + "\n"
                if complete_set: setting_data += ";  Bridge Sparse Infill Max Density: " + str(mycura.getProperty("bridge_sparse_infill_max_density", "value")) + " %\n"
                if complete_set: setting_data += ";  Bridge Wall Coast: " + str(mycura.getProperty("bridge_wall_coast", "value")) + "\n"
                if complete_set: setting_data += ";  Bridge Wall Speed: " + str(mycura.getProperty("bridge_wall_speed", "value")) + " mm/sec\n"
                if complete_set: setting_data += ";  Bridge Wall Matl Flow: " + str(mycura.getProperty("bridge_wall_material_flow", "value")) + " %\n"
                if complete_set: setting_data += ";  Bridge Skin Speed: " + str(mycura.getProperty("bridge_skin_speed", "value")) + " mm/sec\n"
                if complete_set: setting_data += ";  Bridge Skin Matl Flow: " + str(mycura.getProperty("bridge_skin_material_flow", "value")) + " %\n"
                if complete_set: setting_data += ";  Bridge Skin Density: " + str(mycura.getProperty("bridge_skin_density", "value")) + " %\n"
                if complete_set: setting_data += ";  Bridge Fan Speed: " + str(mycura.getProperty("bridge_fan_speed", "value")) + " %\n"
                if complete_set: setting_data += ";  Bridge Enable More Layers: " + str(mycura.getProperty("bridge_enable_more_layers", "value")) + "\n"
                if bool(mycura.getProperty("bridge_enable_more_layers", "value")):
                    if complete_set: setting_data += ";    Bridge Skin Speed 2: " + str(mycura.getProperty("bridge_skin_speed_2", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";    Bridge Skin Matl Flow 2: " + str(mycura.getProperty("bridge_skin_material_flow_2", "value")) + " %\n"
                    if complete_set: setting_data += ";    Bridge Skin Density 2: " + str(mycura.getProperty("bridge_skin_density_2", "value")) + " %\n"
                    if complete_set: setting_data += ";    Bridge Fan Speed 2: " + str(mycura.getProperty("bridge_fan_speed_2", "value")) + " %\n"
                    if complete_set: setting_data += ";      Bridge Skin Speed 3: " + str(mycura.getProperty("bridge_skin_speed_3", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";      Bridge Skin Matl Flow 3: " + str(mycura.getProperty("bridge_skin_material_flow_3", "value")) + " %\n"
                    if complete_set: setting_data += ";      Bridge Skin Density 3: " + str(mycura.getProperty("bridge_skin_density_3", "value")) + " %\n"
                    if complete_set: setting_data += ";      Bridge Fan Speed 3: " + str(mycura.getProperty("bridge_fan_speed_3", "value")) + " %\n"
            ...
            for num in range(0, machine_extruder_count):
                if bool(extruder[num].getProperty("clean_between_layers", "value")):
                    ...
                    if complete_set: setting_data += ";  Wipe Retraction Distance: " + str(mycura.getProperty("wipe_retraction_amount", "value")) + " mm\n"
                    if complete_set: setting_data += ";  Wipe Retraction Extra Prime Amount: " + str(mycura.getProperty("wipe_retraction_extra_prime_amount", "value")) + "mm³\n"
                    if complete_set: setting_data += ";  Wipe Retraction Speed: " + str(mycura.getProperty("wipe_retraction_speed", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";    Wipe Retraction Retract Speed: " + str(mycura.getProperty("wipe_retraction_retract_speed", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";    Wipe Retraction Prime Speed: " + str(mycura.getProperty("wipe_retraction_prime_speed", "value")) + " mm/sec\n"
                    ...
                    if bool(mycura.getProperty("wipe_hop_enable", "value")):
                        if complete_set: setting_data += ";    Wipe Z Hop Height: " + str(mycura.getProperty("wipe_hop_amount", "value")) + " mm\n"
                        if complete_set: setting_data += ";    Wipe Hop Speed: " + str(mycura.getProperty("wipe_hop_speed", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";  Wipe Brush X Position: " + str(mycura.getProperty("wipe_brush_pos_x", "value")) + "\n"
                    if complete_set: setting_data += ";  Wipe Repeat Count: " + str(mycura.getProperty("wipe_repeat_count", "value")) + "\n"
                    if complete_set: setting_data += ";  Wipe Move Distance: " + str(mycura.getProperty("wipe_move_distance", "value")) + " mm\n"
                else:
                    setting_data += ";Extruder " + str(num + 1) + " (T" + str(num) + "):\n"
                    setting_data += ";  Wipe Between Layers: " + str(extruder[num].getProperty("clean_between_layers", "value")) + "\n"
            try:
