...
class AddCuraSettings(Script):
    ...
    def execute(self, data):
        ...
        initial_extruder_nr = global_stack.getProperty("initial_extruder_nr", "value")
        ...
        setting_data += ";    Machine Name: " + str(global_stack.getProperty("machine_name", "value")) + "\n"

        # Extruder Assignments
        wall_extruder_nr = int(global_stack.getProperty("wall_extruder_nr", "value"))
        if wall_extruder_nr == -1: wall_extruder_nr = 0
        wall_0_extruder_nr = int(global_stack.getProperty("wall_0_extruder_nr", "value"))
        if wall_0_extruder_nr == -1: wall_0_extruder_nr = 0
        wall_x_extruder_nr = int(global_stack.getProperty("wall_x_extruder_nr", "value"))
        if wall_x_extruder_nr == -1: wall_x_extruder_nr = 0
        roofing_extruder_nr = int(global_stack.getProperty("roofing_extruder_nr", "value"))
        ...
        support_infill_extruder_nr = int(global_stack.getProperty("support_infill_extruder_nr", "value"))
        if support_infill_extruder_nr == -1: support_infill_extruder_nr = 0
        support_extruder_nr_layer_0 = int(global_stack.getProperty("support_extruder_nr_layer_0", "value"))
        if support_extruder_nr_layer_0 == -1: support_extruder_nr_layer_0 = 0
        support_interface_extruder_nr = int(global_stack.getProperty("support_interface_extruder_nr", "value"))
        if support_interface_extruder_nr == -1: support_interface_extruder_nr = 0
        support_roof_extruder_nr = int(global_stack.getProperty("support_roof_extruder_nr", "value"))
        if support_roof_extruder_nr == -1: support_roof_extruder_nr = 0
        support_bottom_extruder_nr = int(global_stack.getProperty("support_bottom_extruder_nr", "value"))
        if support_bottom_extruder_nr == -1: support_bottom_extruder_nr = 0

        # For Compatibility with 4.x
        try:
            skirt_brim_extruder_nr = int(global_stack.getProperty("skirt_brim_extruder_nr", "value"))
        ...
        if bool(self.getSettingValueByKey("general_set")) or all_or_some == "all_settings":
            ...
            setting_data += ";Quality Base Name: " + str(global_stack.quality.getMetaDataEntry("name", "")) + "\n"
            setting_data += ";Quality Changes Custom Name: " + str(global_stack.qualityChanges.getMetaDataEntry("name")) + "\n"
        ...
        if bool(self.getSettingValueByKey("machine_set")) or all_or_some == "all_settings":
            setting_data += ";\n;  [Machine Settings]\n"
            if complete_set: setting_data += ";Wait for bed heatup: " + str(global_stack.getProperty("material_bed_temp_wait", "value")) + "\n"
            if complete_set: setting_data += ";Wait for Nozzle Heatup: " + str(global_stack.getProperty("material_print_temp_wait", "value")) + "\n"
            if complete_set: setting_data += ";Add Print Temp Before StartUp: " + str(global_stack.getProperty("material_print_temp_prepend", "value")) + "\n"
            if complete_set: setting_data += ";Add Bed Temp Before StartUp: " + str(global_stack.getProperty("material_bed_temp_prepend", "value")) + "\n"
            setting_data += ";Machine Width: " + str(global_stack.getProperty("machine_width", "value")) + " mm\n"
            setting_data += ";Machine Depth: " +	str(global_stack.getProperty("machine_depth", "value")) + " mm\n"
            setting_data += ";Machine Height: " + str(global_stack.getProperty("machine_height", "value")) + " mm\n"
            setting_data += ";Platform: " + str(global_stack.getMetaDataEntry("platform", "value")) + "\n"
            if complete_set: setting_data += ";Machine Bed Shape: " + str(global_stack.getProperty("machine_shape", "value")) + "\n"
            if complete_set: setting_data += ";Machine Bed Heated: " + str(global_stack.getProperty("machine_heated_bed", "value")) + "\n"
            if complete_set: setting_data += ";Machine Heated Build Volume: " + str(global_stack.getProperty("machine_heated_build_volume", "value")) + "\n"
            if complete_set and bool(global_stack.getProperty("machine_heated_build_volume", "value")):
                setting_data += ";Machine Build Volume Fan#: " + str(global_stack.getProperty("build_volume_fan_nr", "value")) + "\n"
            if complete_set: setting_data += ";Machine Center is Zero: " + str(global_stack.getProperty("machine_center_is_zero", "value")) + "\n"
            if complete_set: setting_data += ";Machine Extruder Count: " + str(global_stack.getProperty("machine_extruder_count", "value")) + "\n"
            enabled_list = list([global_stack.isEnabled for global_stack in global_stack.extruderList])
            setting_data += ";Extruders Enabled Count: " + str(len(enabled_list)) + " \n"
            for num in range(0,len(enabled_list)):
                setting_data += ";  Extruder " + str(num + 1) + " (T" + str(num) + ") Enabled: " + str(enabled_list[num]) + " \n"
            if complete_set: setting_data += ";Enable Nozzle Temperature Control: " + str(global_stack.getProperty("machine_nozzle_temp_enabled", "value")) + " \n"
            if complete_set: setting_data += ";Heat Up Speed: " + str(global_stack.getProperty("machine_nozzle_heat_up_speed", "value")) + "°/sec\n"
            ...
            if complete_set:
                ...
                nozzle_dis_areas = global_stack.getProperty("nozzle_disallowed_areas", "value")
                templist = ""
            ...
            for num in range(0,machine_extruder_count):
                ...
                if complete_set and machine_extruder_count > 1:
                    ...
                    setting_data += ";  Use Extruder Offsets in Gcode: " + str(global_stack.getProperty("machine_use_extruder_offset_to_offset_coords", "value")) + "\n"
                    try:
                        if bool(global_stack.getProperty("machine_use_extruder_offset_to_offset_coords", "value")):
            ...
            setting_data += ";Max Feedrate Y: " + str(global_stack.getProperty("machine_max_feedrate_y", "value")) + " mm/sec\n"
            setting_data += ";Max Feedrate Z: " + str(global_stack.getProperty("machine_max_feedrate_z", "value")) + " mm/sec\n"
            setting_data += ";Max Feedrate E: " + str(global_stack.getProperty("machine_max_feedrate_e", "value")) + " mm/sec\n"
            setting_data += ";Max Accel X: " + str(global_stack.getProperty("machine_max_acceleration_x", "value")) + " mm/sec²\n"
            setting_data += ";Max Accel Y: " + str(global_stack.getProperty("machine_max_acceleration_y", "value")) + " mm/sec²\n"
            setting_data += ";Max Accel Z: " + str(global_stack.getProperty("machine_max_acceleration_z", "value")) + " mm/sec²\n"
            setting_data += ";Max Accel E: " + str(global_stack.getProperty("machine_max_acceleration_e", "value")) + " mm/sec²\n"
            setting_data += ";Default Machine Accel: " + str(global_stack.getProperty("machine_acceleration", "value")) + " mm/sec²\n"
            setting_data += ";Default XY Jerk: " + str(global_stack.getProperty("machine_max_jerk_xy", "value")) + " mm/sec\n"
            setting_data += ";Default Z Jerk: " + str(global_stack.getProperty("machine_max_jerk_z", "value")) + " mm/sec\n"
            setting_data += ";Default E Jerk: " + str(global_stack.getProperty("machine_max_jerk_e", "value")) + " mm/sec\n"
            setting_data += ";Steps/mm X: " + str(global_stack.getProperty("machine_steps_per_mm_x", "value")) + " steps/mm\n"
            setting_data += ";Steps/mm Y: " + str(global_stack.getProperty("machine_steps_per_mm_y", "value")) + " steps/mm\n"
            setting_data += ";Steps/mm Z: " + str(global_stack.getProperty("machine_steps_per_mm_z", "value")) + " steps/mm\n"
            setting_data += ";Steps/mm E: " + str(global_stack.getProperty("machine_steps_per_mm_e", "value")) + " steps/mm\n"
        ...
        if bool(self.getSettingValueByKey("quality_set")) or all_or_some == "all_settings":
            setting_data += ";\n;  [Quality Settings]\n"
            setting_data += ";Layer Height: " + str(global_stack.getProperty("layer_height", "value")) + " mm\n"
            setting_data += ";Initial Layer Height: " + str(global_stack.getProperty("layer_height_0", "value")) + " mm\n"
            for num in range(0,machine_extruder_count):
                setting_data += ";Extruder " + str(num + 1) + " (T" + str(num) + "):\n"
            ...
            if bool(global_stack.getProperty("prime_tower_enable", "value")) and machine_extruder_count > 1:
                setting_data += ";Prime Tower Line Width: " + str(global_stack.getProperty("prime_tower_line_width", "value")) + " mm\n"
            setting_data += ";Initial Layer Line Width: " + str(global_stack.getProperty("initial_layer_line_width_factor", "value")) + " %\n"
        ...
        if bool(self.getSettingValueByKey("wall_set")) or all_or_some == "all_settings":
            ...
            if complete_set: setting_data += ";Wall Transition Length: " + str(global_stack.getProperty("wall_transition_length", "value")) + " mm\n"
            setting_data += ";Outer-Wall Wipe Dist: " + str(extruder[wall_0_extruder_nr].getProperty("wall_0_wipe_dist", "value")) + " mm\n"
            if complete_set: setting_data += ";Wall Distribution Count: " + str(global_stack.getProperty("wall_distribution_count", "value")) + "\n"
            ...
            setting_data += ";Print Thin Walls: " + str(global_stack.getProperty("fill_outline_gaps", "value")) + "\n"
        ...
        if bool(self.getSettingValueByKey("topbot_set")) or all_or_some == "all_settings":
            ...
            setting_data += ";Bottom Thickness: " + str(round(global_stack.getProperty("bottom_thickness", "value"),2)) + " mm\n"
            setting_data += ";Bottom Layers: " + str(global_stack.getProperty("bottom_layers", "value")) + "\n"
            setting_data += ";Initial Bottom Layers: " + str(global_stack.getProperty("initial_bottom_layers", "value")) + "\n"
            setting_data += ";Top/Bottom Pattern: " + str(extruder[top_bottom_extruder_nr].getProperty("top_bottom_pattern", "value")) + "\n"
            setting_data += ";Initial Top/Bottom Pattern: " + str(global_stack.getProperty("top_bottom_pattern_0", "value")) + "\n"
            ...
            if complete_set: setting_data += ";Small Top/Bottom Width: " + str(global_stack.getProperty("small_skin_width", "value")) + "\n"
            if complete_set: setting_data += ";Small Top/Bottom On Surface: " + str(global_stack.getProperty("small_skin_on_surface", "value")) + "\n"
            ...
            setting_data += ";Extra Skin Wall Count: " + str(global_stack.getProperty("skin_outline_count", "value")) + "\n"
            ...
            if bool(extruder[top_bottom_extruder_nr].getProperty("ironing_enabled", "value")):
                ...
                setting_data += ";  Ironing Pattern: " + str(global_stack.getProperty("ironing_pattern", "value")) + "\n"
        ...
        if bool(self.getSettingValueByKey("infill_set")) or all_or_some == "all_settings":
            ...
            setting_data += ";Infill Line Distance: " + str(round(extruder[infill_extruder_nr].getProperty("infill_line_distance", "value"),2)) + " mm\n"
        ...
        if bool(self.getSettingValueByKey("material_set")) or all_or_some == "all_settings":
            setting_data += ";\n;  [Material Settings]\n"
            if complete_set: setting_data += ";Heated Build Volume: " + str(global_stack.getProperty("machine_heated_build_volume", "value")) + "\n"
            if complete_set and bool(global_stack.getProperty("machine_heated_build_volume", "value")):
                setting_data += ";Build Volume Temp: " + str(global_stack.getProperty("build_volume_temperature", "value")) + "°\n"
        ...
        if bool(self.getSettingValueByKey("speed_set")) or all_or_some == "all_settings":
            ...
            try:
                ...
                pass
            if bool(global_stack.getProperty("prime_tower_enable", "value")) and machine_extruder_count > 1:
                if complete_set: setting_data += ";Speed Prime Tower: " + str(global_stack.getProperty("speed_prime_tower", "value")) + " mm/sec\n"
            setting_data += ";Slower Initial Layers: " + str(global_stack.getProperty("speed_slowdown_layers", "value")) + "\n"
        ...
        if bool(self.getSettingValueByKey("cooling_set")) or all_or_some == "all_settings":
            ...
            for num in range(0,machine_extruder_count):
                ...
                if bool(extruder[num].getProperty("cool_fan_enabled", "value")):
                    ...
                    setting_data += ";  Cooling Fan Speed at Height: " + str(global_stack.getProperty("build_fan_full_at_height", "value")) + " mm\n"
                    setting_data += ";  Cooling Fan Speed at Layer: " + str(global_stack.getProperty("build_fan_full_layer", "value")) + " layer#\n"
        ...
        if bool(self.getSettingValueByKey("support_set")) or all_or_some == "all_settings":
            setting_data += ";\n;  [Support Settings]\n"
            setting_data += ";Enable Support: " + str(global_stack.getProperty("support_enable", "value")) + "\n"
            if bool(global_stack.getProperty("support_enable", "value")):
                if machine_extruder_count > 1:
                ...
                if complete_set and str(extruder[support_extruder_nr].getProperty("support_structure", "value")) == "tree":
                    ...
                    setting_data += ";Preferred Branch Angle: " + str(round(extruder[support_infill_extruder_nr].getProperty("support_tree_angle_slow", "value"),2)) + "°\n"
                    ...
                    setting_data += ";Limit Branch Reach: " + str(global_stack.getProperty("support_tree_limit_branch_reach", "value")) + " mm\n"
                    setting_data += ";Optimal Branch Range: " + str(global_stack.getProperty("support_tree_branch_reach_limit", "value")) + " mm\n"
                    setting_data += ";Rest Preference: " + str(global_stack.getProperty("support_tree_rest_preference", "value")) + " mm\n"
                ...
                setting_data += ";Fan Speed Override: " + str(global_stack.getProperty("support_fan_enable", "value")) + "\n"
                setting_data += ";Supported Skin Fan Speed: " + str(global_stack.getProperty("support_supported_skin_fan_speed", "value")) + "°\n"
                setting_data += ";Support Use Towers: " + str(global_stack.getProperty("support_use_towers", "value")) + "\n"
                if complete_set: setting_data += ";Support Tower Diameter: " + str(global_stack.getProperty("support_tower_diameter", "value")) + " mm\n"
                ...
                if complete_set: setting_data += ";Dropdown Support Mesh: " + str(global_stack.getProperty("support_mesh_drop_down", "value")) + "\n"
                if complete_set: setting_data += ";Scene Has Support Meshes: " + str(global_stack.getProperty("support_meshes_present", "value")) + "\n"
        ...
        if bool(self.getSettingValueByKey("adhesion_set")) or all_or_some == "all_settings":
            ...
            if complete_set:
                try:
                    ...
                    pass
            setting_data += ";Adhesion Type: " + str(global_stack.getProperty("adhesion_type", "value")) + "\n"
            if str(global_stack.getProperty("adhesion_type", "value")) != "none":
                if machine_extruder_count > 1:
                    ...
                    try:
                        ...
                        pass
                if str(global_stack.getProperty("adhesion_type", "value")) == "skirt":
                ...
                elif str(global_stack.getProperty("adhesion_type", "value")) == "brim":
                ...
                elif str(global_stack.getProperty("adhesion_type", "value")) == "raft":
                    if machine_extruder_count > 1:
                    ...
                    if complete_set: setting_data += ";Raft Remove Inside Corners: " + str(global_stack.getProperty("raft_remove_inside_corners", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";Raft Remove Base Inside Corners: " + str(global_stack.getProperty("raft_base_remove_inside_corners", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";Raft Remove Middle Inside Corners: " + str(global_stack.getProperty("raft_interface_remove_inside_corners", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";Raft Remove Top Inside Corners: " + str(global_stack.getProperty("raft_surface_remove_inside_corners", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";Raft Smoothing: " + str(global_stack.getProperty("raft_smoothing", "value")) + " mm\n"
                    if complete_set: setting_data += ";Raft Base Smoothing: " + str(global_stack.getProperty("raft_base_smoothing", "value")) + " mm\n"
                    if complete_set: setting_data += ";Raft Middle Smoothing: " + str(global_stack.getProperty("raft_interface_smoothing", "value")) + " mm\n"
                    if complete_set: setting_data += ";Raft Top Smoothing: " + str(global_stack.getProperty("raft_surface_smoothing", "value")) + " mm\n"
                    ...
                    if complete_set: setting_data += ";Raft Wall Count: " + str(global_stack.getProperty("raft_wall_count", "value")) + "\n"
                    if complete_set: setting_data += ";Raft Base Wall Count: " + str(global_stack.getProperty("raft_base_wall_count", "value")) + "\n"
                    if complete_set: setting_data += ";Raft Interface Wall Count: " + str(global_stack.getProperty("raft_interface_wall_count", "value")) + "\n"
                    if complete_set: setting_data += ";Raft Top Wall Count: " + str(global_stack.getProperty("raft_surface_wall_count", "value")) + "\n"
        ...
        if (bool(self.getSettingValueByKey("dualext_set")) or all_or_some == "all_settings") and machine_extruder_count > 1:
            ...
            setting_data += ";Prime Tower Enable: " + str(global_stack.getProperty("prime_tower_enable", "value")) + "\n"
            if bool(global_stack.getProperty("prime_tower_enable", "value")):
                setting_data += ";  Prime Tower Type: " + str(global_stack.getProperty("prime_tower_mode", "value")) + "\n"
                setting_data += ";  Prime Tower Size: " + str(global_stack.getProperty("prime_tower_size", "value")) + "\n"
                for num in range(0, machine_extruder_count):
                    setting_data += ";  Prime Tower Min Volume: " + str(global_stack.getProperty("prime_tower_min_volume", "value")) + " mm³\n"
                    if complete_set: setting_data += ";  Prime Tower Max Bridging Distance: " + str(global_stack.getProperty("prime_tower_max_bridging_distance", "value")) + " mm\n"
                    if complete_set: setting_data += ";  Prime Tower Min Shell Thickness: " + str(global_stack.getProperty("prime_tower_min_shell_thickness", "value")) + " mm\n"
                setting_data += ";  Prime Tower X Pos: " + str(global_stack.getProperty("prime_tower_position_x", "value")) + "\n"
                setting_data += ";  Prime Tower Y Pos: " + str(global_stack.getProperty("prime_tower_position_y", "value")) + "\n"
                if complete_set: setting_data += ";  Prime Tower Wipe Enabled: " + str(global_stack.getProperty("prime_tower_wipe_enabled", "value")) + "\n"
                setting_data += ";  Prime Tower Brim: " + str(global_stack.getProperty("prime_tower_brim_enable", "value")) + "\n"
                setting_data += ";  Prime Tower Base Size: " + str(global_stack.getProperty("prime_tower_base_size", "value")) + " mm\n"
                if complete_set: setting_data += ";  Prime Tower Base Height: " + str(global_stack.getProperty("prime_tower_base_height", "value")) + " mm\n"
                ...
                if complete_set: setting_data += ";  Prime Tower Raft Line Spacing: " + str(global_stack.getProperty("prime_tower_raft_base_line_spacing", "value")) + " mm\n"
            setting_data += ";Ooze Shield Enable: " + str(global_stack.getProperty("ooze_shield_enabled", "value")) + "\n"
            if bool(global_stack.getProperty("ooze_shield_enabled", "value")):
                if complete_set: setting_data += ";  Ooze Shield Angle: " + str(global_stack.getProperty("ooze_shield_angle", "value")) + "°\n"
                if complete_set: setting_data += ";  Ooze Shield Distance: " + str(global_stack.getProperty("ooze_shield_dist", "value")) + " mm\n"
            if machine_extruder_count > 1:
                for num in range(0, machine_extruder_count):
                    setting_data += ";Extruder " + str(num + 1) + " (T" + str(num) + "):\n"
        ...
        if bool(self.getSettingValueByKey("meshfix_set")) or all_or_some == "all_settings":
            setting_data += ";\n;  [Mesh Fixes Settings]\n"
            setting_data += ";Union Overlapping Volumes: " + str(global_stack.getProperty("meshfix_union_all", "value")) + "\n"
            setting_data += ";Remove All Holes: " + str(global_stack.getProperty("meshfix_union_all_remove_holes", "value")) + "\n"
            if complete_set: setting_data += ";Extensive Stitching: " + str(global_stack.getProperty("meshfix_extensive_stitching", "value")) + "\n"
            if complete_set: setting_data += ";Keep Disconnected Faces: " + str(global_stack.getProperty("meshfix_keep_open_polygons", "value")) + "\n"
            if complete_set: setting_data += ";Merged Mesh Overlap: " + str(global_stack.getProperty("multiple_mesh_overlap", "value")) + " mm\n"
            if complete_set: setting_data += ";Remove Mesh Intersection: " + str(global_stack.getProperty("carve_multiple_volumes", "value")) + "\n"
            if complete_set: setting_data += ";Alternate Mesh Removal: " + str(global_stack.getProperty("alternate_carve_order", "value")) + "\n"
            setting_data += ";Remove Empty First Layers: " + str(global_stack.getProperty("remove_empty_first_layers", "value")) + "\n"
            if complete_set: setting_data += ";Maximum Resolution: " + str(global_stack.getProperty("meshfix_maximum_resolution", "value")) + " mm\n"
            if complete_set: setting_data += ";Maximum Travel Resolution: " + str(global_stack.getProperty("meshfix_maximum_travel_resolution", "value")) + " mm\n"
            if complete_set: setting_data += ";Maximum Deviation: " + str(global_stack.getProperty("meshfix_maximum_deviation", "value")) + " mm\n"
            if complete_set: setting_data += ";Maximum Extrusion Area Deviation: " + str(global_stack.getProperty("meshfix_maximum_extrusion_area_deviation", "value")) + " µm²\n"
            setting_data += ";Fluid Motion Enable: " + str(global_stack.getProperty("meshfix_fluid_motion_enabled", "value")) + "\n"
            if complete_set: setting_data += ";Fluid Motion Shift Distance: " + str(global_stack.getProperty("meshfix_fluid_motion_shift_distance", "value")) + " mm\n"
            if complete_set: setting_data += ";Fluid Motion Small Distance: " + str(global_stack.getProperty("meshfix_fluid_motion_small_distance", "value")) + " mm\n"
            if complete_set: setting_data += ";Fluid Motion Angle: " + str(global_stack.getProperty("meshfix_fluid_motion_angle", "value")) + "°\n"

        # Special Modes
        if bool(self.getSettingValueByKey("special_set")) or all_or_some == "all_settings":
            setting_data += ";\n;  [Special Modes]\n"
            setting_data += ";Print Sequence: " + str(global_stack.getProperty("print_sequence", "value")) + "\n"
            setting_data += ";Mold Enabled: " + str(global_stack.getProperty("mold_enabled", "value")) + "\n"
            if bool(global_stack.getProperty("mold_enabled", "value")):
                setting_data += ";Mold Width: " + str(global_stack.getProperty("mold_width", "value")) + " mm\n"
                setting_data += ";Mold Roof Height: " + str(global_stack.getProperty("mold_roof_height", "value")) + " mm\n"
                setting_data += ";Mold Angle: " + str(global_stack.getProperty("mold_angle", "value")) + "°\n"
            setting_data += ";Surface Mode: " + str(global_stack.getProperty("magic_mesh_surface_mode", "value")) + "\n"
            setting_data += ";Spiralize: " + str(global_stack.getProperty("magic_spiralize", "value")) + "\n"
            if bool(global_stack.getProperty("magic_spiralize", "value")):
                setting_data += ";  Smooth Spiralized Contours : " + str(global_stack.getProperty("smooth_spiralized_contours", "value")) + "\n"
            setting_data += ";Relative Extrusion: " + str(global_stack.getProperty("relative_extrusion", "value")) + "\n"

        # Experimental
        if bool(self.getSettingValueByKey("experimental_set")) or all_or_some == "all_settings":
            setting_data += ";\n;  [Experimental Settings]\n"
            setting_data += ";Slicing Tolerance: " + str(global_stack.getProperty("slicing_tolerance", "value")) + "\n"
            ...
            if bool(global_stack.getProperty("interlocking_enable", "value")):
                if machine_extruder_count > 1:
                    for num in range(0, machine_extruder_count):
                        setting_data += ";Extruder " + str(num + 1) + " (T" + str(num) + "):\n"
                ...
                setting_data += ";  Interlock Orientation: " + str(global_stack.getProperty("interlocking_orientation", "value")) + "\n"
                setting_data += ";  Interlock Beam Layer Count: " + str(global_stack.getProperty("interlocking_beam_layer_count", "value")) + "\n"
                setting_data += ";  Interlock Depth: " + str(global_stack.getProperty("interlocking_depth", "value")) + " mm\n"
                setting_data += ";  Interlock Avoid: " + str(global_stack.getProperty("interlocking_boundary_avoidance", "value")) + "\n"
            ...
            setting_data += ";Draft Shield Enable: " + str(global_stack.getProperty("draft_shield_enabled", "value")) + "\n"
            if bool(global_stack.getProperty("draft_shield_enabled", "value")) and complete_set:
                setting_data += ";  Draft Shield Distance: " + str(global_stack.getProperty("draft_shield_dist", "value")) + " mm\n"
                setting_data += ";  Draft Shield Limitation: " + str(global_stack.getProperty("draft_shield_height_limitation", "value")) + " mm\n"
                setting_data += ";  Draft Shield Height: " + str(global_stack.getProperty("draft_shield_height", "value")) + " mm\n"
            setting_data += ";Make Overhang Printable: " + str(global_stack.getProperty("conical_overhang_enabled", "value")) + "\n"
            if bool(global_stack.getProperty("conical_overhang_enabled", "value")) and complete_set:
                setting_data += ";  Maximum Model Angle: " + str(global_stack.getProperty("conical_overhang_angle", "value")) + " mm\n"
                setting_data += ";  Maximum Overhang Hole Area: " + str(global_stack.getProperty("conical_overhang_hole_size", "value")) + " mm\n"
            setting_data += ";Coasting Enable: " + str(global_stack.getProperty("coasting_enable", "value")) + "\n"
            if bool(global_stack.getProperty("coasting_enable", "value")):
                if machine_extruder_count > 1 and complete_set:
                    for num in range(0, machine_extruder_count):
                        setting_data += ";Extruder " + str(num + 1) + " (T" + str(num) + "):\n"
            ...
            if complete_set: setting_data += ";Cross 3D Pocket Size: " + str(round(extruder[infill_extruder_nr].getProperty("cross_infill_pocket_size", "value"),2)) + " mm²\n"
            ...
            if bool(global_stack.getProperty("support_conical_enabled", "value")) and complete_set:
                if machine_extruder_count > 1:
                    for num in range(0, machine_extruder_count):
                        setting_data += ";Extruder " + str(num + 1) + " (T" + str(num) + "):\n"
            ...
            setting_data += ";Flow Rate Compensation Max Extrusion Offset: " + str(global_stack.getProperty("flow_rate_max_extrusion_offset", "value")) + " mm\n"
            setting_data += ";Flow Rate Compensation Factor: " + str(global_stack.getProperty("flow_rate_extrusion_offset_factor", "value")) + " %\n"
            setting_data += ";Adaptive Layers: " + str(global_stack.getProperty("adaptive_layer_height_enabled", "value")) + "\n"
            if bool(global_stack.getProperty("adaptive_layer_height_enabled", "value")):
                setting_data += ";  Adaptive Height Variation: " + str(global_stack.getProperty("adaptive_layer_height_variation", "value")) + "\n"
            ...
            if bool(global_stack.getProperty("bridge_settings_enabled", "value")):
                if complete_set: setting_data += ";  Bridge Wall Min Length: " + str(global_stack.getProperty("bridge_wall_min_length", "value")) + "\n"
                if complete_set: setting_data += ";  Bridge Skin Supt Threshold: " + str(global_stack.getProperty("bridge_skin_support_threshold", "value")) + "\n"
                if complete_set: setting_data += ";  Bridge Sparse Infill Max Density: " + str(global_stack.getProperty("bridge_sparse_infill_max_density", "value")) + " %\n"
                if complete_set: setting_data += ";  Bridge Wall Coast: " + str(global_stack.getProperty("bridge_wall_coast", "value")) + "\n"
                if complete_set: setting_data += ";  Bridge Wall Speed: " + str(global_stack.getProperty("bridge_wall_speed", "value")) + " mm/sec\n"
                if complete_set: setting_data += ";  Bridge Wall Matl Flow: " + str(global_stack.getProperty("bridge_wall_material_flow", "value")) + " %\n"
                if complete_set: setting_data += ";  Bridge Skin Speed: " + str(global_stack.getProperty("bridge_skin_speed", "value")) + " mm/sec\n"
                ...
                if bool(global_stack.getProperty("bridge_enable_more_layers", "value")):
                    ...
                    if complete_set: setting_data += ";    Bridge Skin Matl Flow 2: " + str(global_stack.getProperty("bridge_skin_material_flow_2", "value")) + " %\n"
                    if complete_set: setting_data += ";    Bridge Skin Density 2: " + str(global_stack.getProperty("bridge_skin_density_2", "value")) + " %\n"
                    if complete_set: setting_data += ";    Bridge Fan Speed 2: " + str(global_stack.getProperty("bridge_fan_speed_2", "value")) + " %\n"
                    if complete_set: setting_data += ";      Bridge Skin Speed 3: " + str(global_stack.getProperty("bridge_skin_speed_3", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";      Bridge Skin Matl Flow 3: " + str(global_stack.getProperty("bridge_skin_material_flow_3", "value")) + " %\n"
                    if complete_set: setting_data += ";      Bridge Skin Density 3: " + str(global_stack.getProperty("bridge_skin_density_3", "value")) + " %\n"
                    if complete_set: setting_data += ";      Bridge Fan Speed 3: " + str(global_stack.getProperty("bridge_fan_speed_3", "value")) + " %\n"
            setting_data += ";Alternate Wall Directions: " + str(global_stack.getProperty("material_alternate_walls", "value")) + "\n"
            for num in range(0, machine_extruder_count):
                if bool(extruder[num].getProperty("clean_between_layers", "value")):
                    ...
                    setting_data += ";  Wipe Retraction Enable: " + str(global_stack.getProperty("wipe_retraction_enable", "value")) + "\n"
                    if complete_set: setting_data += ";  Wipe Retraction Distance: " + str(global_stack.getProperty("wipe_retraction_amount", "value")) + " mm\n"
                    if complete_set: setting_data += ";  Wipe Retraction Extra Prime Amount: " + str(global_stack.getProperty("wipe_retraction_extra_prime_amount", "value")) + "mm³\n"
                    if complete_set: setting_data += ";  Wipe Retraction Speed: " + str(global_stack.getProperty("wipe_retraction_speed", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";    Wipe Retraction Retract Speed: " + str(global_stack.getProperty("wipe_retraction_retract_speed", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";    Wipe Retraction Prime Speed: " + str(global_stack.getProperty("wipe_retraction_prime_speed", "value")) + " mm/sec\n"
                    setting_data += ";  Wipe Pause: " + str(global_stack.getProperty("wipe_pause", "value")) + "\n"
                    setting_data += ";  Wipe Z Hop: " + str(global_stack.getProperty("wipe_hop_enable", "value")) + "\n"
                    if bool(global_stack.getProperty("wipe_hop_enable", "value")):
                        if complete_set: setting_data += ";    Wipe Z Hop Height: " + str(global_stack.getProperty("wipe_hop_amount", "value")) + " mm\n"
                        if complete_set: setting_data += ";    Wipe Hop Speed: " + str(global_stack.getProperty("wipe_hop_speed", "value")) + " mm/sec\n"
                    if complete_set: setting_data += ";  Wipe Brush X Position: " + str(global_stack.getProperty("wipe_brush_pos_x", "value")) + "\n"
                    if complete_set: setting_data += ";  Wipe Repeat Count: " + str(global_stack.getProperty("wipe_repeat_count", "value")) + "\n"
                    if complete_set: setting_data += ";  Wipe Move Distance: " + str(global_stack.getProperty("wipe_move_distance", "value")) + " mm\n"
                else:
                    setting_data += ";Extruder " + str(num + 1) + " (T" + str(num) + "):\n"
                    setting_data += ";  Wipe Between Layers: " + str(extruder[num].getProperty("clean_between_layers", "value")) + "\n"
            try:
        ...
        if bool(self.getSettingValueByKey("postprocess_set")):
