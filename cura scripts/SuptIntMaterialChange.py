...
By GregValiant (Greg Foresi) November 2023
    ...
    RULES:
        ...
        > It was apparent during testing that too high of a temperature during unload could cause filament to break off in the hot end.  The 'Unload Temperature' for the model material and the interface material have been added.  Those temperatures should be near the 'Cold Pull' temperature of each material.
