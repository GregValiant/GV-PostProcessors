...
class PrintSkewCompensation(Script):
    def initialize(self) -> None:
        ...
        # Get the "Printer Name.log" file and parse it for the settings.  If there isn't a log file, then create it at the end of the script
        lines = None
        ...
        try:
            ...
            config_file = config_path + "\\scripts\\" + active_printer + ".log"
    ...
    def execute(self, data: list):
        ...
        self._writeSettings(config_file)
        return data
    ...
    def _writeSettings(self, config_file: str):
        dest_file = open(config_file, "w+")
        dest_file.write('"printer_name":' + str(self.printer_name).strip() + "\n")
        dest_file.write('"compensation_method":' + str(self.compensation_method).strip() + "\n")
        dest_file.write('"xy_ac_dist":' + str(self.xy_ac_dist) + "\n")
        dest_file.write('"xy_bd_dist":' + str(self.xy_bd_dist) + "\n")
        dest_file.write('"xy_ad_dist":' + str(self.xy_ad_dist) + "\n")
        dest_file.write('"xz_ac_dist":' + str(self.xz_ac_dist) + "\n")
        dest_file.write('"xz_bd_dist":' + str(self.xz_bd_dist) + "\n")
        dest_file.write('"xz_ad_dist":' + str(self.xz_ad_dist) + "\n")
        dest_file.write('"yz_ac_dist":' + str(self.yz_ac_dist) + "\n")
        dest_file.write('"yz_bd_dist":' + str(self.yz_bd_dist) + "\n")
        dest_file.write('"yz_ad_dist":' + str(self.yz_ad_dist) + "\n")
        dest_file.write('"xy_skew_factor":' + str(round(self.xy_skew_factor,8)) + "\n")
        dest_file.write('"xz_skew_factor":' + str(round(self.xz_skew_factor,8)) + "\n")
        dest_file.write('"yz_skew_factor":' + str(round(self.yz_skew_factor,8)) + "\n")
        dest_file.write('"add_settings_to_gcode":' + str(self.add_settings_to_gcode))
        dest_file.close()
        return None