...
*Please NOTE:* If your 'Before_Layer_Change' Gcode has ';Layer{layer_num+1}' or something similar, you should remove it or you will end up with double ";layer:X" lines.  The slicer adds it's line after the post processors run and so cannot be used in post-process.  You should remove the line from your before layer change gcode.
