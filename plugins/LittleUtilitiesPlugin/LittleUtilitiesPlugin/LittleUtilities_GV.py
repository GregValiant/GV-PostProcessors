        ...
        return """{
            ...
            "settings":
            {
                ...
                "debug_start_layer":
                {
                    ...
                    "description": "Use the Cura preview numbers.  This will be the first layer to remove the extrusions from.  Earlier Layers will be deleted",
                    "type": "int",
                    "default_value": 1,
                    "minimum_value": 1,
                    "enabled": "debug_file and debugging_tools"
                ...
                "debug_end_layer":
                {
                    ...
                    "description": "Use ' -1 ' to indicate the top layer or use the Cura preview layer number.  This will be the last layer to have extrusions removed.  Layers above this one will be deleted.  If you want to stop before the last layer then use the Cura preveiw numbers.",
                    "type": "int",
                    "default_value": 25,
                    "minimum_value": debug_start_layer + 1,
                    "enabled": "debug_file and debugging_tools"
                },
